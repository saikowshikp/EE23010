...
\hhline{|-------|}
	...
	\gnumericColD+%
	\tabcolsep*2*1}|}%
	{\gnumericPB{\centering}\gnumbox{$\myvec{3.12\\0.26}$}}
	&\multicolumn{3}{c|}%
...
\hhline{|----|~~~}
	...
	\gnumericColD+%
	\tabcolsep*2*1}|}%
	{\gnumericPB{\centering}\gnumbox{$\myvec{0.26\\-3.12}$}}
	&
	&
...
\hhline{|----|~~~}
	...
	\gnumericColD+%
	\tabcolsep*2*1}|}%
	{\gnumericPB{\centering}\gnumbox{-1.03}}
	&
	&
	&\multicolumn{1}{p{\gnumericColG}|}%
	{}
...
\hhline{|-------|}
	...
	\gnumericColD+%
	\tabcolsep*2*1}|}%
	{\gnumericPB{\centering}\gnumbox{$\myvec{-0.88\\-3.74}$}}
	&\multicolumn{3}{c|}%
	{\setlength{\gnumericMultiRowLength}{0pt}%
	 \addtolength{\gnumericMultiRowLength}{\gnumericColE}%
	 \addtolength{\gnumericMultiRowLength}{\gnumericColF}%
...
\hhline{|----|~~~}
	...
	\gnumericColD+%
	\tabcolsep*2*1}|}%
	{\gnumericPB{\centering}\gnumbox{$\myvec{-3.74\\0.88}$}}
	&
	&
	&\multicolumn{1}{p{\gnumericColG}|}%
	{}
...
\hhline{|----|~~~}
	...
	\gnumericColD+%
	\tabcolsep*2*1}|}%
	{\gnumericPB{\centering}\gnumbox{3.53}}
	&
	&
	&\multicolumn{1}{p{\gnumericColG}|}%
	{}
...
\hhline{|-------|}
	...
	\gnumericColD+%
	\tabcolsep*2*1}|}%
	{\gnumericPB{\centering}\gnumbox{$\myvec{-3.88\\5.26}$}}
	&\multicolumn{3}{c|}%
	{\setlength{\gnumericMultiRowLength}{0pt}%
	 \addtolength{\gnumericMultiRowLength}{\gnumericColE}%
	 \addtolength{\gnumericMultiRowLength}{\gnumericColF}%
...
\hhline{|----|~~~}
	...
	\gnumericColD+%
	\tabcolsep*2*1}|}%
	{\gnumericPB{\centering}\gnumbox{$\myvec{5.26\\3.88}$}}
	&
	&
	&\multicolumn{1}{p{\gnumericColG}|}%
	{}
...
\hhline{|----|~~~}
	...
	\gnumericColD+%
	\tabcolsep*2*1}|}%
	{\gnumericPB{\centering}\gnumbox{-3.64}}
	&
	&
	&\multicolumn{1}{p{\gnumericColG}|}%
	{}
...
\hhline{|-------|}
	...
	\gnumericColD+%
	\tabcolsep*2*1}|}%
	{\gnumericPB{\centering}\gnumbox{$\myvec{-0.88\\0.26}$}}
	&\multicolumn{3}{p{	\gnumericColE+%
	\gnumericColF+%
	\gnumericColG+%
	\tabcolsep*2*2}|}%
...
\hhline{|-------|}
	...
	\gnumericColD+%
	\tabcolsep*2*1}|}%
	{\gnumericPB{\centering}\gnumbox{$\myvec{1.03\\0.89}$}}
	&\multicolumn{3}{p{	\gnumericColE+%
	\gnumericColF+%
	\gnumericColG+%
	\tabcolsep*2*2}|}%
...
\hhline{|-------|}
	...
	\gnumericColD+%
	\tabcolsep*2*1}|}%
	{\gnumericPB{\centering}\gnumbox{$\myvec{-2.06\\-1.38}$}}
	&\multicolumn{3}{p{	\gnumericColE+%
	\gnumericColF+%
	\gnumericColG+%
	\tabcolsep*2*2}|}%
...
\hhline{|-------|}
	...
	\gnumericColD+%
	\tabcolsep*2*1}|}%
	{\gnumericPB{\centering}\gnumbox{$\myvec{2.31\\1.68}$}}
	&\multicolumn{3}{p{	\gnumericColE+%
	\gnumericColF+%
	\gnumericColG+%
	\tabcolsep*2*2}|}%
...
\hhline{|-------|}
	...
	{\setlength{\gnumericMultiRowLength}{0pt}%
	 ...
	 \gnumericPB{\centering}\gnumbox{$40.27\degree$}}}}
	&\multicolumn{3}{c|}%
	{\setlength{\gnumericMultiRowLength}{0pt}%
	 \addtolength{\gnumericMultiRowLength}{\gnumericColE}%
	 \addtolength{\gnumericMultiRowLength}{\gnumericColF}%
...
\hhline{|-------|}
	...
	{\setlength{\gnumericMultiRowLength}{0pt}%
	 ...
	 \addtolength{\gnumericMultiRowLength}{\tabcolsep}%
	 \multirow{2}[1]{\gnumericMultiRowLength}{\parbox{\gnumericMultiRowLength}{%
	 \gnumericPB{\centering}\gnumbox{$31.72\degree$}}}}
	&\multicolumn{3}{c|}%
	{\setlength{\gnumericMultiRowLength}{0pt}%
	 \addtolength{\gnumericMultiRowLength}{\gnumericColE}%
	 \addtolength{\gnumericMultiRowLength}{\gnumericColF}%
